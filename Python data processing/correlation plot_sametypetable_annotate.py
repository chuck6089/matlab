...
params = {
          "fileA_name": "MTF1_Idolphin_03052020.csv", 
          "fileB_name": "MTF2_07102020_collimatoraperture&noaperture.csv",
		    "dataPath": "data",
          "labelA": "MTF1",
          "labelB": "MTF2_collimatoraperture_07102020_ROI1000",
          "method": "mean",
          #"fileA_filterDict": None, 
#          "fileA_filterDict": {"H": "Y", "G": "Green"},
#          "fileB_filterDict": {"I": "Green", "F": "N"},
          #"fileB_filterDict": None,
#          "fileA_filterDict": {"D": "5-Mar","H":"Green" , "F": "BlueRight"},
#          "fileB_filterDict": {"D": "13-Mar","H":"Green", "F": "BlueRight"},
          "fileA_filterDict": None,
          "fileB_filterDict": {"D":"collimator","G":"blue"},
          "fileA_sampleIdCol": ["A"], 
          "fileA_varCol": ["O"],
          "fileB_sampleIdCol" : ["A"], 
          "fileB_varCol": ["X"],         
          "figPath": "figs",
          #"dropSampeId": ['19B175.04.12','19B175.04.21'],
          "dropSampeId": [],
           }    
...
def PlotFigure(merged, fileAColName,fileBColName, lab1, lab2):
    ...
    for ix, txt in enumerate(sampleIds):
        plt.annotate(txt, (x[ix]-.00002,y[ix]+0.00002))
        #plt.annotate(txt, (x[ix]-.2,y[ix]+0.1))
